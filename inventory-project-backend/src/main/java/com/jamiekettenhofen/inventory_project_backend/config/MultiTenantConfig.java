package com.jamiekettenhofen.inventory_project_backend.config;

import com.jamiekettenhofen.inventory_project_backend.tenant.*;
...
public class MultiTenantConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.jamiekettenhofen.inventory_project_backend.model"); //MODEL not ENTITY AAAAAAAAAAAAAHH
