...
@SqlResultSetMapping(
    ...
    classes = @ConstructorResult(
        targetClass = com.kitcheninventory.inventory_project_backend.dto.ReminderDTO.class,
        columns = {
            ...
            @ColumnResult(name = "purchaseid", type = Long.class),
...
@Entity
@Table(name = "dummy")
public class ReminderDTOMapperConfig {
